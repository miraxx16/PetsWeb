...
<body>
    ...
    <main class="main-wrap" id="main">
        ...
        <div class="container-fluid main-content">
            <div class="row wrap-content p-5">
                <!-- left content here -->
                <?php include 'left_content.php'; ?>
                <!-- center content -->
                <div class="col-xl-8 col-lg-12 center-content p-3">
                    <div class="">
                        <form action="query.php?user_id=<?php echo $row->userID ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="image-upload d-flex justify-content-between">
                                ...
                                <label>
                                    <a class="d-flex" data-toggle="collapse" data-target="#postContainer"><img src="assets/img/flaticon/upload.png">
                                        <h6>Add an image</h6>
                                    </a>
                                </label>
                                ...
                                <button class="btn btn-primary btn-post" name="btn-post" type="submit">POST</button>
                            </div>
                            <div class="post_container collapse" id="postContainer">
                                <div class="drag">
                                    <span class="inner">Drag & drop image or <span class="select">Browse</span></span>
                                    <input type="file" name="fileUpload[]" id="file" class="file" multiple="" change="getImagePreview(event)">
                                </div>
                            ...
                            <div class=" feature-cont">
                                <div class="card" style="width: 18rem;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="card-btn">
                                            <ul>
                                                <li><a href="#" class="btn btn-primary"><i class="fa-solid fa-plus"></i>
                                                        Pet Friend</a></li>
